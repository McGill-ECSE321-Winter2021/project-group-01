...
//		assertEquals(carList.get(0).getModel(),testCustomer.getCars().get(0).getModel());
//		assertEquals(carList.get(0).getPlateNumber(),testCustomer.getCars().get(0).getPlateNumber());
