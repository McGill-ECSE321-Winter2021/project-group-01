...
<div style="background-color:#262626;">
      ...
      <div class="overlay"></div>
    	<div class="container">
    			<div class="col-md-10 col-lg-6 half p-4 py-7 pl-lg-7">
    				<h3 class="mb-6">Business Holidays</h3>
...
<input type="date" class="form-control appointment_date" placeholder="Date">		            		
                	...
                	<div class="col-md-5">
                       ...
                       <h5> End Time </h5>
			              ...
			              <input type="submit" value="Add Holiday" class="btn btn-dark py-3 px-5">
			            </div>
			            </div>
                                                  								</div>
              ...
              <form action="#" class="appointment">
                <div class="row">
                 ...
                 <!--	<div class="col-md-6">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <input type="submit" value="Add the reminder" class="btn btn-dark py-3 px-4">
                    </div>
                  </div>
              ...
              <form action="#" class="appointment">
                <div class="row">
                    ...
                    <div class="form-group">
                      <div class="form-field">
                        <div class="select-wrap">
                          <div class="icon"><span class="fa fa-chevron-down"></span></div>
                          <select name="" id="" class="form-control">
                            <option value="">Current service of the reminder</option>
                            <option value="">Change Oil</option>
                            <option value="">Engine Repair</option>
                            <option value="">Battery Replace</option>
                            <option value="">Change Tire</option>
                 ...
                 <!--	<div class="col-md-6">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <input type="submit" value="update the reminder" class="btn btn-dark py-3 px-4">
                    </div>
                  </div>
