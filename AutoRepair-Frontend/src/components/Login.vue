...
<section class="ftco-appointment ftco-section ftco-no-pt ftco-no-pb img" style="background-image: url(../static/images/image_6.jpg);">
			<div class="overlay"></div>
    	<div class="container">
    				...
    				<form action="#" class="appointment">
    					<div class="row">
    						<div class="col-md-12">
								...
								<div class="col-md-12">
									<div class="form-group">
                    <button type="button" class="btn btn-dark py-3 px-4" onClick="location.href='/#/signup'">Sign up now!</button>
                  </div>
								</div>
    					</div>
	          </form>
